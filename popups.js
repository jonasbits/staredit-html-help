...
1memq8p = "You can place units on this terrain, and units can cross this terrain in the game. This includes terrain such as dirt, grass and concrete."
...
23rtfxo = "Units that are placed under the control of a player that send any units near."
19dcpiq = "The Player can see terrain but cannot see any troops or activity in the area."
definition_playerx = "Players are any units that are controlled by humans or the computer."
1l9w5lx = "Current Player is the player that the trigger is evaluating the condition/action for."
11bkybb = "Allies are any players that are allied with you, or are a part of the same force."
27yjrcd = "Neutral Players are all players that are listed as Neutral under the player settings."
